...
func run() {
	...
	sheet, anims, err := loadAnimationSheet("sprite.png", "sprite_coordinates.csv", 12)
	if err != nil {
		panic(err)
	}
	...
	// hardcoded level
	platforms := []platform{
		{rect: pixel.R(-1000, -11, 100, -10)},
		{rect: pixel.R(150, -11, 300, -10)},
		{rect: pixel.R(-10, 1.5, 20, 2)},
		{rect: pixel.R(40, 10, 60, 12)},
	}
